...
class RemindersLocalRepositoryTest {
    ...
    @Before
    fun setupRepo() {
        remindersDatabase = Room.inMemoryDatabaseBuilder(ApplicationProvider.getApplicationContext(), RemindersDatabase::class.java).build()    //Initialize remindersDatabase (RemindersDatabase)
