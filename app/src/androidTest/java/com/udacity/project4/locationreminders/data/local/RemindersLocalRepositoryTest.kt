...
class RemindersLocalRepositoryTest {
    ...
    @Before
    fun setupRepo() {
        remindersDatabase = Room.inMemoryDatabaseBuilder(InstrumentationRegistry.getInstrumentation().context, RemindersDatabase::class.java).build()    //Initialize remindersDatabase (RemindersDatabase)
        remindersDaoo = remindersDatabase.reminderDao()    //Initialize remindersDaoo
